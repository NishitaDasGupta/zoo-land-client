      ...
      <div className=" text-neutral-content">
        <div className="grid lg:grid-cols-2 gap-6 p-36">
          ...
          <div className="max-w-2xl">
            <h1 className="mb-5 p-4 text-2xl bg-orange-400/90 border-l-8 border-orange-800 text-white font-semibold">Animal Toys Galore!</h1>

            <p className="mb-5 border-l-8 border-orange-500 text-xl bg-stone-600/70 p-4">Explore our vast selection of animal toys and bring home endless fun. From cute and cuddly to interactive and educational, our toys will spark imagination and create cherished memories. Shop now and let the adventures begin!</p>
            <button className="btn ml-7 border-white bg-slate-600 hover:bg-slate-800">Shop now</button>
            <button className="btn ml-7 border-white  bg-transparent  hover:bg-slate-800">Explore</button>
          </div>
        </div>
      </div>
    </div>
